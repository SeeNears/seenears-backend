...
class TodayQuestionsResponseTest {

    @Test
    void recordedTodayQuestionsResponseExposesMoodTypeInsteadOfQuestionUsed() throws JsonProcessingException {
        ...
        String json = new ObjectMapper()
                ...
                .writeValueAsString(TodayQuestionsResponse.recorded(dailyRecord));

        assertThat(json).contains("\"source\":\"RECORDED\"");
        assertThat(json).contains("\"alreadyRecorded\":true");
        ...
        assertThat(json).contains("\"questions\":null");
